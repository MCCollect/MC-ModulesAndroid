...
import com.mc.mcmodules.databinding.FrgAutorizacioneBinding
...
import com.mc.mcmodules.view.pinhc.fragment.SignatureDialogFragment
import com.mc.mcmodules.viewmodel.firmae.AutorizacionEViewmodel
...
class FrgAutorizacionE(
    private val dataInfoAutorizacion: DataInfoAutorizacion
) : Fragment(), ActivityResultHandler, OnSignedCaptureListener {

    private lateinit var selfViewModel: AutorizacionEViewmodel
    private lateinit var binding: FrgAutorizacioneBinding
    ...
    private fun initContentView(inflater: LayoutInflater, container: ViewGroup?): View {
        selfViewModel = ViewModelProvider(this).get(AutorizacionEViewmodel::class.java)
        selfViewModel.setInstanceCompanionViewModel(selfViewModel)
        binding =
            DataBindingUtil.inflate(inflater, R.layout.frg_autorizacione, container, false)
