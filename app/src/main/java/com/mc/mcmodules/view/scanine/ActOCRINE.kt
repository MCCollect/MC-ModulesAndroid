...
//                    startActivityForResult(intent, CODIGO_INTENT_QR)
    ...
    private fun initListeners() {
        with(binding.lyBottomSheet) {
            buttonUpdateFields.setOnClickListener {
                if (contentIngresoManual.visibility == View.VISIBLE) {
                    contentIngresoManual.visibility = View.GONE
                } else {
                    contentIngresoManual.visibility = View.VISIBLE
    ...
    private fun initBottomSheet() {
        with(binding) {
            sheetBehaviorIne = BottomSheetBehavior.from<RelativeLayout>(lyBottomSheet.bottomSheetIne)
        }
